...
const VALID_PASS = "Password must be 8 digits and letters!"
const VALID_PHONE = "Phone must be 11 digits long!"
const VALID_MAIL = "The example of @mail \"test@test.test\"!"
